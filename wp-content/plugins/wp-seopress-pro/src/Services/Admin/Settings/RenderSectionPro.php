    ...
    public function render($key)
    {
        ...
        $sections = [
            ...
            'woocommerce'=> [
                ...
                'alert'  => sprintf(__('We also recommend <a class="nav-tab" %s>adding WooCommerce directives to your robots.txt</a> file to reduce your crawl budget.','wp-seopress-pro'), 'id="tab_seopress_robots-tab" href="?page=seopress-pro-page#tab=tab_seopress_robots" style="
                display: inline;
                margin: inherit;
                padding: inherit;
            ...
            'ai'=> [
                ...
                'desc'   => __('Use the power of OpenAI to improve your productivity.', 'wp-seopress-pro'),
            ],
        ];
