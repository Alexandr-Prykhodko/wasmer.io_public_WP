...
<input type="text" name="seopress_pro_option_name[seopress_local_business_url]"
    placeholder="<?php printf(esc_html__('default: %s', 'wp-seopress-pro'), esc_url(get_home_url())); ?>"
...
<p class="description"><?php echo wp_kses_post('<span class="field-recommended">Recommended</span> property by Google.', 'wp-seopress-pro'); ?>
</p>
