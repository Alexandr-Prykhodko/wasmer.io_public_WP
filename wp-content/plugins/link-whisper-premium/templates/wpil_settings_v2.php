                ...
                <form name="frmSaveSettings" id="frmSaveSettings" action='' method='post'>
                    ...
                    <table class="form-table">
                        ...
                        <tr class="wpil-advanced-settings wpil-setting-row">
                            <td scope='row'><?php esc_html_e('Only Use These Posts in Suggestions', 'wpil'); ?></td>
                            <td>
                                ...
                                <div class="wpil_help">
                                    ...
                                    <div class="display-under">
                                        <?php
                                            esc_html_e('This setting allows you to tell Link Whisper which posts it should show in the Suggestions.', 'wpil');
                                            echo '<br /><br />';
                                            esc_html_e('To add a post, please enter each it\'s URL on its own line in the field.', 'wpil');
                                            echo '<br /><br />';
                                            esc_html_e('Wildcard matching is supported using an asterisk (*). For example, putting "https://example.com/blog/*" in the field will tell Link Whisper that it\'s ok to make suggestions to "https://example.com/blog/first-post", "https://example.com/blog/test-post", and "https://example.com/blog/most-recent-post"', 'wpil');
                                        ?>
                                    </div>
                                </div>
                                <div style="clear:both;"></div>
                        ...
                        <tr class="wpil-domain-settings wpil-setting-row">
                            ...
                            <td>
                                <textarea name='wpil_new_tab_ignore_domains' id='wpil_new_tab_ignore_domains' style="width: 800px;float:left;" class='regular-text' rows=10><?php echo esc_textarea(get_option('wpil_new_tab_ignore_domains', '')); ?></textarea>
                                <div class="wpil_help">
                                    <i class="dashicons dashicons-editor-help"></i>
                                    <div style="margin: -150px 0px 0px 30px;">
                                        <?php 
                        ...
                        <tr class="wpil-ai-settings wpil-setting-row">
                            ...
                            <td>
                                ...
                                <?php
                                if(!$has_oai_api_key){ ?>
                                    <a style="font-size: 14px !important; margin: 0 0 0 15px; font-weight:600" href="https://linkwhisper.com/knowledge-base/how-do-i-get-my-open-ai-key/" target="_blank">[<?php esc_html_e('How to get your OpenAI API key', 'wpil'); ?>]</a>
                                <?php } ?>
                                <div class="wpil_help">
                                    <i class="dashicons dashicons-editor-help"></i>
                                    <div style="margin: -150px 0px 0px 30px;">
                                        <?php 
                                        _e('This is where you enter your OpenAI API key.', 'wpil');
                                        echo '<br /><br />';
                                        _e('Link Whisper will use the API key to make processing requests from OpenAI.', 'wpil');
                                        echo '<br /><br />';
                                        _e('Many requests will result in a charge to your OpenAI account balance, and it is recommended that you set a monthly budget for your API key that you are comfortable with.', 'wpil');
                                        ?>
                                    </div>
                                </div>
                                <div style="clear:both;"></div>
                        ...
                        <tr class="wpil-ai-settings wpil-setting-row wpil-disable-ai-suggestion-cron <?php echo (!empty($has_oai_api_key) && !empty($ai_use_ai_suggestions)) ? '': 'hide-setting'; ?>">
                            <td scope='row'><?php _e('Disable AI Powered Suggestion Cron Task', 'wpil'); ?></td>
                            <td>
                                <div style="display: inline-block; position: relative;">
                        ...
                        <tr id="wpil-account-dashboard-notice" class="wpil-advanced-settings wpil-setting-row">
                            <td scope='row' class="wpil-setting-name-row"><?php esc_html_e('Activate Account Dashboard Syncing', 'wpil'); ?></td>
                            <td class="wpil-setting-input-row">
                                <div class="wpil-setting-input-container" style="max-width:80px;">
                                    <input type="hidden" name="wpil_remote_dashboard" value="0" />
                                    <input type="checkbox" name="wpil_remote_dashboard" <?php echo !empty(get_option('wpil_remote_dashboard', 1)) ? 'checked': ''; ?> value="1" />
                                    <div class="wpil_help" style="float:right;">
                                        <i class="dashicons dashicons-editor-help" style="margin-top: 6px;"></i>
                                        <div style="margin: -100px 0 0 30px;">
                                            <?php esc_html_e("The Account Dashboard Syncing allows Link Whisper to sync this site\'s report data with your LinkWhisper.com account so you can view your reports inside of your account.", 'wpil'); ?>
                                            <br>
                                            <br>
                                            <?php esc_html_e("This is helpful when you have multiple sites that you want to keep track of without logging into each one of them and checking the dashboard.", 'wpil'); ?>
                                            <br>
                                            <br>
                                            <?php esc_html_e("No personal data is sent during the sync, and turning this setting off will disable the data sync.", 'wpil'); ?>
                                        </div>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr class="wpil-advanced-settings wpil-setting-row">
                            <td scope='row'><?php esc_html_e('Sync Account Dashboard Now', 'wpil'); ?></td>
                            <td class="wpil-setting-input-row">
                                <div class="wpil-setting-input-container" style="max-width:80px;">
                                    <input type="hidden" name="wpil_sync_account_dashboard" value="0" />
                                    <input type="checkbox" name="wpil_sync_account_dashboard" value="1" />
                                    <div class="wpil_help" style="float:right;">
                                        <i class="dashicons dashicons-editor-help" style="margin-top: 6px;"></i>
                                        <div style="margin: -100px 0 0 30px;">
                                            <?php esc_html_e("Turning on this option and saving the settings will tell Link Whisper to sync this site with your LinkWhisper.com account so you can view up to date report information there.", 'wpil'); ?>
                                            <br>
                                            <br>
                                            <?php esc_html_e("If you just installed or updated Link Whisper, doing this is a good idea.", 'wpil'); ?>
                                        </div>
                                    </div>
                                </div>
                            </td>
