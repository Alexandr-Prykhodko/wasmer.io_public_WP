        ...
        <div id="post-body" class="metabox-holder">
            <div id="post-body-content" style="position: relative;">
                ...
                function wpilDashboardgetStatusIcon($count){
                    return (WP_INTERNAL_LINKING_PLUGIN_URL . '/images/') . ($count === 0 ? 'check.png' : 'spanner.png');
                }
                ?>
                <div id="report_dashboard <?php echo ($loading) && false ? 'wpil-dashboard-report-is-loading': '';?> ">
                    ...
                    <div class="reportcontainer topbarhandle">
                        <div class="reportbox unclickbox">
                            <div class="blockdash">
                                <h3>Posts Crawled</h3>
                                <a href="javascript:void(0)" <?php echo Wpil_Toolbox::generate_tooltip_text('dashboard-link-stats-widget-posts-crawled-stat'); ?>><span class="wpil-report-stats-posts-crawled"><?=Wpil_Dashboard::getPostCount()?></span>
                                </a>
                            </div>
                        </div>
                        <div class="reportbox unclickbox">
                        ...
                        <div class="reportbox <?php echo (!empty($orphanedCount)) ? 'clickbox': ''; ?>">
                            <span class="informativeicons actiondiv">
                                <img src="<?php echo wpilDashboardgetStatusIcon($orphanedCount); ?>" />
                            </span>
                            <div class="blockdash" onclick="window.location.href='<?=admin_url('admin.php?page=link_whisper&type=links&orphaned=1')?>'">
                                <h3>Orphaned Posts</h3>
                                <?php if($loading){ ?>
                                    <a href="javascript:void(0)" <?php echo Wpil_Toolbox::generate_tooltip_text('dashboard-link-stats-widget-orphaned-posts-stat'); ?>><div class="wpil-report-dashboard-loading la-ball-clip-rotate la-mid"><div style="border-color: black;border-bottom-color: transparent;"></div></div>
                                <?php } else { ?>
                                    <a href="javascript:void(0)" <?php echo Wpil_Toolbox::generate_tooltip_text('dashboard-link-stats-widget-orphaned-posts-stat'); ?>><?=Wpil_Dashboard::getOrphanedPostsCount()?>
                                <?php } ?>
                                </a>
                            </div>
                        </div>
                        <div class="reportbox <?php echo (!empty($brokenLinksCount)) ? 'clickbox': ''; ?>" onclick="window.location.href='<?= htmlspecialchars(admin_url('admin.php?page=link_whisper&type=error' . $codes)) ?>'">
                            <span class="informativeicons actiondiv">
                                <img src="<?= wpilDashboardgetStatusIcon($brokenLinksCount); ?>" />
                            </span>
                            <div class="blockdash">
                                <h3>Broken Links</h3>
                                <a href="javascript:void(0)" <?php echo Wpil_Toolbox::generate_tooltip_text('dashboard-link-stats-widget-broken-links-stat'); ?>><?=Wpil_Dashboard::getBrokenLinksCount()?>
                                </a>
                            </div>
                        </div>
                        <div class="reportbox <?php echo (!empty($notfoundLinksCount)) ? 'clickbox': ''; ?>">
                            <span class="informativeicons actiondiv">
                                <img src="<?= wpilDashboardgetStatusIcon($notfoundLinksCount); ?>" />
                            </span>
                            <div class="blockdash">
                                <h3>404 errors</h3>
                                <a href="<?=admin_url('admin.php?page=link_whisper&type=error&codes=404')?>" <?php echo Wpil_Toolbox::generate_tooltip_text('dashboard-link-stats-widget-404-links-stat'); ?>><?=Wpil_Dashboard::get404LinksCount()?>
                                </a>
                            </div>
                        </div>
                    </div>
