...
//                        $('#wpbody-content').html(response.loading_screen);
                    ...
                    animateTheReportLoadingBar(response, '.wpil-wizard-post-progress-loader');
            ...
            success: function(response){
                ...
                if (response.finish) {
                    ...
                    if(doingAutolinks === 'yes'){
                        // unhide the loaders
                        $('.wpil-wizard-autolink-progress-header, .wpil-wizard-autolink-progress-loader').css({'display': 'flex'});
