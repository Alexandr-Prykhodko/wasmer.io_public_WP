...
//        'feature-notification'
    ...
    public static function cron_email_check(){
        ...
        foreach($last_sends as $id => $time){
            ...
            if(($time + $recurring_freqs[$id]) < time()){
                // tee up the email
                $next_up = $id;
                // and exist the loop
                break;
